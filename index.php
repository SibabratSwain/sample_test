...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>I'm <span>Sibabrat Swain</span> a Sr Lead Developer at Collins Aerospace</h2>
  ...
  <footer id="footer" class="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Collins Aerospace</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Sibabrat Swain</a>
      </div>
    </div>
  </footer><!-- End Footer -->
...
zip your_app.zip -r * .[^.]*
this will add all the files into a zip file.

http://sibabratphpportfolioapp55-env.eba-xvcztx4z.ap-south-1.elasticbeanstalk.com/
this is a bootstrap theme I have added, please check this out with multiple CSS, js, and HTML files into it.
